...
- its external fixture freezes all 72 operation/target-kind pairings, both
  present and absent optional binding error context, private fields, absence
  of `Hash` and `Default`, three Core feature cells, and downstream
  compilation;
