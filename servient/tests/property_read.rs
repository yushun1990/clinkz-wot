...
mod tests {
    ...
    use super::support::property_read_binding::{
    ...
    #[test]
    fn static_readiness_failure_returns_route_to_abort_cleanup() {
        let (binding, probe) = static_property_read_readiness_failure_fixture();
        let thing_slot = ThingSlotId::new(SlotIndex::new(0), Generation::INITIAL);
        let handler = Handler {
